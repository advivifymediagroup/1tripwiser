    ...
    <div class="tw-nav-inner">
        ...
        <a class="tw-brand" href="<?php echo esc_url(home_url('/')); ?>" aria-label="<?php bloginfo('name'); ?> Home">
            <?php if ( has_custom_logo() ) :
                ...
                /* Logo displays at max 60px tall (see .tw-custom-logo in style.css) but
                   ...
                   a 60px-tall logo. Request a size close to actual display dimensions
                   (with headroom for retina) so WordPress serves a properly small
                   intermediate image instead. */
                echo wp_get_attachment_image( $tw_logo_id, array( 240, 120 ), false, array(
